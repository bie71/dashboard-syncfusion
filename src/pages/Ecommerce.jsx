  ...
  return (
    <div className="mt-24">
      <div className="flex justify-center">
        <div
          id="banner"
          className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-xl w-full lg:w-9/12 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-center"
        >
          <div className="flex justify-between items-center">
            <div>
              <p className="font-bold text-gray-400">Earnigs</p>
              <p className="text-2xl">$64,750.88</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
